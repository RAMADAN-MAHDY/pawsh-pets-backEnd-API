...
export const seedProducts = async (): Promise<void> => {
  try {
    ...
    const productsToSeed: Partial<IProduct>[] = [
      {
        ...
        rating: 4.5,
        isFavorite: false,
        category: dryFoodCategory._id as Types.ObjectId,
      },
      {
        ...
        rating: 4.8,
        isFavorite: true,
        category: wetFoodCategory._id as Types.ObjectId
      },
      {
        ...
        rating: 4.2,
        isFavorite: false,
        category: toysCategory._id as Types.ObjectId
      },
      {
...
export const deleteProducts = async (): Promise<void> => {
  try {
